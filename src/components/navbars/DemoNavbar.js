              ...
              >
                <UncontrolledDropdown nav>
                  ...
                  >
                    ...
                    <span className="nav-link-inner--text">Init</span>
                  </DropdownToggle>
                  <DropdownMenu className="dropdown-menu-xl">
                    <div className="dropdown-menu-inner">
                      ...
                      >
                        ...
                        <Media body className="ml-3">
                          ...
                          <p className="description d-none d-md-inline-block mb-0">
                            Learn how to upload pictures, change parameters
                            and more.
                          </p>
                        </Media>
                      </Media>
                      ...
                      >
                        ...
                        <Media body className="ml-3">
                          ...
                          <p className="description d-none d-md-inline-block mb-0">
                            Welcome to use our amazing AI-powered application.
                          </p>
                        </Media>
                      </Media>
                    </div>
                    <div className="dropdown-menu-footer">
                      ...
                      <DropdownItem href="https://www.creative-tim.com/learning-lab/reactstrap/core-accordions/argon-design-system">
                        <i className="ni ni-archive-2"></i> Price
                      </DropdownItem>
                    </div>
                  </DropdownMenu>
                </UncontrolledDropdown>
                ...
                <UncontrolledDropdown nav>
                  ...
                  <DropdownMenu aria-labelledby="navbarDropdownMenuLink">
                    <DropdownItem to="/test" tag={Link}>
                      <i className="ni ni-world text-info"></i>
                      test(for dev)
                    </DropdownItem>
